...
Here, we import mean intensity per cell
```{r select-counts}
...
# Delete unneeded CSV files from the root directory
```{r clean-up, message=F}
file.remove("CellSubset.csv", "All_Image.csv", "CellTypes.csv", "Donors.csv")
```
