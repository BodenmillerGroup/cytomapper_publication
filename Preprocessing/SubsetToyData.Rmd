...
write_tif(imageData(transpose(A02_tiff_subsetted)), 
          path = "/Users/nils/Github/IMCMapper/inst/extdata/A02_imc.tiff",
          bits_per_sample = 32L, overwrite = TRUE)
system("mv /Users/nils/Github/IMCMapper/inst/extdata/A02_imc.tif /Users/nils/Github/IMCMapper/inst/extdata/A02_imc.tiff")
write_tif(imageData(transpose(D01_tiff_subsetted)), 
          path = "/Users/nils/Github/IMCMapper/inst/extdata/D01_imc.tiff",
          bits_per_sample = 32L, overwrite = TRUE)
system("mv /Users/nils/Github/IMCMapper/inst/extdata/D01_imc.tif /Users/nils/Github/IMCMapper/inst/extdata/D01_imc.tiff")
write_tif(imageData(transpose(F01_tiff_subsetted)), 
          path = "/Users/nils/Github/IMCMapper/inst/extdata/F01_imc.tiff",
          bits_per_sample = 32L, overwrite = TRUE)
system("mv /Users/nils/Github/IMCMapper/inst/extdata/F01_imc.tif /Users/nils/Github/IMCMapper/inst/extdata/F01_imc.tiff")

write_tif(imageData(transpose(A02_mask_subsetted)), 
          path = "/Users/nils/Github/IMCMapper/inst/extdata/A02_mask.tiff",
          bits_per_sample = 16L, overwrite = TRUE)
system("mv /Users/nils/Github/IMCMapper/inst/extdata/A02_mask.tif /Users/nils/Github/IMCMapper/inst/extdata/A02_mask.tiff")
write_tif(imageData(transpose(D01_mask_subsetted)), 
          path = "/Users/nils/Github/IMCMapper/inst/extdata/D01_mask.tiff",
          bits_per_sample = 16L, overwrite = TRUE)
system("mv /Users/nils/Github/IMCMapper/inst/extdata/D01_mask.tif /Users/nils/Github/IMCMapper/inst/extdata/D01_mask.tiff")
write_tif(imageData(transpose(F01_mask_subsetted)), 
          path = "/Users/nils/Github/IMCMapper/inst/extdata/F01_mask.tiff",
          bits_per_sample = 16L, overwrite = TRUE)
system("mv /Users/nils/Github/IMCMapper/inst/extdata/F01_mask.tif /Users/nils/Github/IMCMapper/inst/extdata/F01_mask.tiff")
```

# Create example image lists

```{r example-image-lists}
pancreasMasks <- IMCImageList(A02_mask = A02_mask_subsetted, 
                           D01_mask = D01_mask_subsetted, 
                           F01_mask = F01_mask_subsetted)
elementMetadata(pancreasMasks) <- DataFrame(ImageNb = 1:3)

pancreasImages <- IMCImageList(A02_imc = A02_tiff_subsetted, 
...
```{r}
save(pancreasSCE, file = "/Users/nils/Github/IMCMapper/data/pancreasSCE.RData")
save(pancreasMasks, file = "/Users/nils/Github/IMCMapper/data/pancreasMasks.RData")
save(pancreasImages, file = "/Users/nils/Github/IMCMapper/data/pancreasImages.RData")
```
