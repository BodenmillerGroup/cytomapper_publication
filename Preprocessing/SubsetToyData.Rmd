...
# Adding toy cell-types and masks
...
system("mv /Users/nils/Github/SingleCellMapper/inst/extdata/A02_imc.tif /Users/nils/Github/SingleCellMapper/inst/extdata/A02_imc.tiff")
write_tif(D01_tiff_subsetted@.Data, 
          path = "/Users/nils/Github/SingleCellMapper/inst/extdata/D01_imc.tiff",
          bits_per_sample = 32L, overwrite = TRUE)
system("mv /Users/nils/Github/SingleCellMapper/inst/extdata/D01_imc.tif /Users/nils/Github/SingleCellMapper/inst/extdata/D01_imc.tiff")
write_tif(F01_tiff_subsetted@.Data, 
          path = "/Users/nils/Github/SingleCellMapper/inst/extdata/F01_imc.tiff",
          bits_per_sample = 32L, overwrite = TRUE)
system("mv /Users/nils/Github/SingleCellMapper/inst/extdata/F01_imc.tif /Users/nils/Github/SingleCellMapper/inst/extdata/F01_imc.tiff")
...
system("mv /Users/nils/Github/SingleCellMapper/inst/extdata/A02_mask.tif /Users/nils/Github/SingleCellMapper/inst/extdata/A02_mask.tiff")
write_tif(D01_mask_subsetted@.Data, 
          path = "/Users/nils/Github/SingleCellMapper/inst/extdata/D01_mask.tiff",
          bits_per_sample = 16L, overwrite = TRUE)
system("mv /Users/nils/Github/SingleCellMapper/inst/extdata/D01_mask.tif /Users/nils/Github/SingleCellMapper/inst/extdata/D01_mask.tiff")
write_tif(F01_mask_subsetted@.Data, 
          path = "/Users/nils/Github/SingleCellMapper/inst/extdata/F01_mask.tiff",
          bits_per_sample = 16L, overwrite = TRUE)
system("mv /Users/nils/Github/SingleCellMapper/inst/extdata/F01_mask.tif /Users/nils/Github/SingleCellMapper/inst/extdata/F01_mask.tiff")
```

# Create example image lists

```{r example-image-lists}
pancreasMasks <- ImageList(A02 = A02_mask_subsetted, D01 = D01_mask_subsetted, F01 = F01_mask_subsetted)
elementMetadata(pancreasMasks) <- DataFrame(ImageNb = 1:3)

pancreasImages <- ImageList(A02 = A02_tiff_subsetted, D01 = D01_tiff_subsetted, F01 = F01_tiff_subsetted)
...
```{r}
save(pancreasSCE, file = "/Users/nils/Github/SingleCellMapper/data/pancreasSCE.RData")
save(pancreasMasks, file = "/Users/nils/Github/SingleCellMapper/data/pancreasMasks.RData")
save(pancreasImages, file = "/Users/nils/Github/SingleCellMapper/data/pancreasImages.RData")
```
