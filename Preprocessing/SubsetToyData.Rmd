...
write_tif(A02_tiff_subsetted@.Data, 
          path = "/Users/nils/switchdrive/Institution/SingleCellMapper/Data/for_package/images/A02_imc.tiff",
          bits_per_sample = 32L, overwrite = TRUE)
write_tif(D01_tiff_subsetted@.Data, 
          path = "/Users/nils/switchdrive/Institution/SingleCellMapper/Data/for_package/images/D01_imc.tiff",
          bits_per_sample = 32L, overwrite = TRUE)
write_tif(F01_tiff_subsetted@.Data, 
          path = "/Users/nils/switchdrive/Institution/SingleCellMapper/Data/for_package/images/F01_imc.tiff",
          bits_per_sample = 32L, overwrite = TRUE)

write_tif(A02_mask_subsetted@.Data, 
          path = "/Users/nils/switchdrive/Institution/SingleCellMapper/Data/for_package/images/A02_mask.tiff",
          bits_per_sample = 16L, overwrite = TRUE)
write_tif(D01_mask_subsetted@.Data, 
          path = "/Users/nils/switchdrive/Institution/SingleCellMapper/Data/for_package/images/D01_mask.tiff",
          bits_per_sample = 16L, overwrite = TRUE)
write_tif(F01_mask_subsetted@.Data, 
          path = "/Users/nils/switchdrive/Institution/SingleCellMapper/Data/for_package/images/F01_mask.tiff",
          bits_per_sample = 16L, overwrite = TRUE)
```
...
```{r}
save(sce_subsetted, file = "/Users/nils/switchdrive/Institution/SingleCellMapper/Data/for_package/data/pancreasSCE.RData")
save(masks, file = "/Users/nils/switchdrive/Institution/SingleCellMapper/Data/for_package/data/pancreasMasks.RData")
save(images, file = "/Users/nils/switchdrive/Institution/SingleCellMapper/Data/for_package/data/pancreasImages.RData")
```
