...
The analysis was performed using cytomapper version 1.0.0, Bioconductor version 3.11 and R version 4.0.
...
We will now confirm that this is reflected on the original images by plotting the corresponding pixel-level data with the `plotPixels` function. 
